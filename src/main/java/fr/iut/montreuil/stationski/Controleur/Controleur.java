...
public class Controleur implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Terrain terrain = new Terrain(45,45,1, ChoixMap.getChoix(), vueTerrain.créerListeTerrain());
        ...
        ListChangeListener<Entite> pvListen = (c -> {if(this.env.getPV()<=0){
            gameLoop.stop();
            Terrain resetTerrain = new Terrain(45,45,1, ChoixMap.getChoix(), vueTerrain.créerListeTerrain());
